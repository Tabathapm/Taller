...
<%--                                <form:input path="email" id="email" type="email" class="form-control" placeholder="ejemplo@email.com"/>--%>
                                <input id="email" type="email" class="form-control" placeholder="ejemplo@email.com">
                            </div>
                            <div class="input-group p-2 d-flex align-items-center">
<%--                                <form:input path="password" type="password" id="password" class="form-control" placeholder="**********"/>--%>
                                <input path="password" type="password" id="password" class="form-control" placeholder="**********">
                            </div>
                            <br>
                            <button class="btn btn-primary w-100" Type="Submit"/>Registrarme</button>
                        </form:form>
                        <br>
                        <p>¿Ya tenés una cuenta? <a href="login">Iniciar sesion</a></p>
