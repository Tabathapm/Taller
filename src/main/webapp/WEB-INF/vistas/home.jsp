...
<%--									<li class="w-100">--%>
<%--										<a href="#" class="nav-link px-0"> <span class="d-none d-sm-inline">Asignar tripulacion de vuelo</span>--%>
...
<%--							</li>--%>
<%--&lt;%&ndash;							<li>&ndash;%&gt;--%>
<%--&lt;%&ndash;								<a href="#" class="nav-link px-0 align-middle">&ndash;%&gt;--%>
<%--&lt;%&ndash;									<i class="fs-4 bi-table"></i> <span class="ms-1 d-none d-sm-inline">Hangar disponible para vuelo saliente</span></a>&ndash;%&gt;--%>
<%--&lt;%&ndash;							</li>&ndash;%&gt;--%>
<%--&lt;%&ndash;							<li>&ndash;%&gt;--%>
<%--&lt;%&ndash;								<a href="#submenu2" data-bs-toggle="collapse" class="nav-link px-0 align-middle ">&ndash;%&gt;--%>
<%--&lt;%&ndash;									<i class="fs-4 bi-bootstrap"></i> <span class="ms-1 d-none d-sm-inline">Hangar disponible para vuelo entrante</span></a>&ndash;%&gt;--%>
